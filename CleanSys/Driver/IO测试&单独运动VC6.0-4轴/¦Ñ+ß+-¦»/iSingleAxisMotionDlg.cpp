...
long CISingleAxisMotionDlg::GetPosition()
{
	...
	m_DMCWin.Command(cCmd, szCurnPos, sizeof(szCurnPos));
...
int CISingleAxisMotionDlg::GetStatus()
{
	...
	m_DMCWin.Command(cCmd, szStatus, sizeof(szStatus));
...
void CISingleAxisMotionDlg::OnBtnretzero() 
{
	switch(m_nAxis) 
	{
		case 0:	m_DMCWin.Command("HM;BGX");	break;
		case 1:	m_DMCWin.Command("HM;BGY");	break;
		case 2:	m_DMCWin.Command("HM;BGZ");	break;
		case 3:	m_DMCWin.Command("HM;BGW");	break;
		default:		break;
	}
